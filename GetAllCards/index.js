...
module.exports = async function (context, req) {   
    ...
    try {
        ...
        let query = "SELECT CardId, Name, Description, Price, Quantity, ImageUrl FROM Cards WHERE Quantity > 0";
        if (userId) {
        ...
        console.error("Errore durante il recupero delle carte:", error.message);
        context.res = {
            status: 500,
